 ...
 * 
 * //https://memorynotfound.com/spring-mail-sending-email-inline-attachment-
 * example/
 * 
 * @Service public class EmailServiceImp {
 * 
 ...
 * 
 * 
 * public static void sendSimpleMessage(String toEmail, String subject, String
 * message) { try {
 * 
